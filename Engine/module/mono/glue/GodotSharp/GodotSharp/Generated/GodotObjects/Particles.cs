...
{
    /// <summary>
    /// <para>3D particle node used to create a variety of particle systems and effects. <see cref="Godot.Particles"/> features an emitter that generates some number of particles at a given rate.</para>
    ...
    /// <para>Note: <see cref="Godot.Particles"/> only work when using the GLES3 renderer. If using the GLES2 renderer, use <see cref="Godot.CPUParticles"/> instead. You can convert <see cref="Godot.Particles"/> to <see cref="Godot.CPUParticles"/> by selecting the node, clicking the Particles menu at the top of the 3D editor viewport then choosing Convert to CPUParticles.</para>
    /// <para>Note: On macOS, <see cref="Godot.Particles"/> rendering is much slower than <see cref="Godot.CPUParticles"/> due to transform feedback being implemented on the CPU instead of the GPU. Consider using <see cref="Godot.CPUParticles"/> instead when targeting macOS.</para>
    /// <para>Note: After working on a Particles node, remember to update its <see cref="Godot.Particles.VisibilityAabb"/> by selecting it, clicking the Particles menu at the top of the 3D editor viewport then choose Generate Visibility AABB. Otherwise, particles may suddenly disappear depending on the camera position and angle.</para>
    /// </summary>
    public partial class Particles : GeometryInstance
    {
        /// <summary>
        /// <para>Maximum number of draw passes supported.</para>
        /// </summary>
        public const int MaxDrawPasses = 4;
...
#pragma warning restore CS0618
        ...
        /// <summary>
        /// <para>The number of particles emitted in one emission cycle (corresponding to the <see cref="Godot.Particles.Lifetime"/>).</para>
        /// <para>Note: Changing <see cref="Godot.Particles.Amount"/> will reset the particle emission, therefore removing all particles that were already emitted before changing <see cref="Godot.Particles.Amount"/>.</para>
        /// </summary>
        public int Amount
        {
            get
...
#pragma warning restore CS0618
        ...
        /// <para>Grow the box if particles suddenly appear/disappear when the node enters/exits the screen. The <see cref="Godot.AABB"/> can be grown via code or with the Particles → Generate AABB editor tool.</para>
        /// <para>Note: If the <see cref="Godot.ParticlesMaterial"/> in use is configured to cast shadows, you may want to enlarge this AABB to ensure the shadow is updated when particles are off-screen.</para>
        /// </summary>
...
#pragma warning restore CS0618
        ...
        /// <summary>
        /// <para>Particle draw order. Uses <see cref="Godot.Particles.DrawOrderEnum"/> values.</para>
        /// </summary>
        public Particles.DrawOrderEnum DrawOrder
        {
            get
#pragma warning disable CS0618 // Disable warning about obsolete method
            {
...
#pragma warning restore CS0618
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private static IntPtr method_bind_7 = Object.godot_icall_Object_ClassDB_get_method(nativeName, "set_visibility_aabb");

        [GodotMethod("set_visibility_aabb")]
        [Obsolete("SetVisibilityAabb is deprecated. Use the VisibilityAabb property instead.")]
        public void SetVisibilityAabb(AABB aabb)
        {
            NativeCalls.godot_icall_1_157(method_bind_7, Object.GetPtr(this), ref aabb);
        }
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private static IntPtr method_bind_20 = Object.godot_icall_Object_ClassDB_get_method(nativeName, "get_visibility_aabb");

        [GodotMethod("get_visibility_aabb")]
        [Obsolete("GetVisibilityAabb is deprecated. Use the VisibilityAabb property instead.")]
        public AABB GetVisibilityAabb()
        {
            NativeCalls.godot_icall_0_158(method_bind_20, Object.GetPtr(this), out AABB argRet); return (AABB)argRet;
        }
        ...
        public void SetDrawOrder(Particles.DrawOrderEnum order)
        {
        ...
        {
            return (Particles.DrawOrderEnum)NativeCalls.godot_icall_0_721(method_bind_27, Object.GetPtr(this));
        }

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private static IntPtr method_bind_28 = Object.godot_icall_Object_ClassDB_get_method(nativeName, "set_draw_passes");

        [GodotMethod("set_draw_passes")]
        [Obsolete("SetDrawPasses is deprecated. Use the DrawPasses property instead.")]
        public void SetDrawPasses(int passes)
        {
            NativeCalls.godot_icall_1_4(method_bind_28, Object.GetPtr(this), passes);
        }

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private static IntPtr method_bind_29 = Object.godot_icall_Object_ClassDB_get_method(nativeName, "set_draw_pass_mesh");

        /// <summary>
        /// <para>Sets the <see cref="Godot.Mesh"/> that is drawn at index <c>pass</c>.</para>
        /// </summary>
        [GodotMethod("set_draw_pass_mesh")]
        [Obsolete("SetDrawPassMesh is deprecated. Use the DrawPass4 property instead.")]
        public void SetDrawPassMesh(int pass, Mesh mesh)
        {
            NativeCalls.godot_icall_2_58(method_bind_29, Object.GetPtr(this), pass, Object.GetPtr(mesh));
        }

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private static IntPtr method_bind_30 = Object.godot_icall_Object_ClassDB_get_method(nativeName, "get_draw_passes");

        [GodotMethod("get_draw_passes")]
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private static IntPtr method_bind_31 = Object.godot_icall_Object_ClassDB_get_method(nativeName, "get_draw_pass_mesh");

        /// <summary>
        /// <para>Returns the <see cref="Godot.Mesh"/> that is drawn at index <c>pass</c>.</para>
        /// </summary>
        [GodotMethod("get_draw_pass_mesh")]
        [Obsolete("GetDrawPassMesh is deprecated. Use the DrawPass4 property instead.")]
        public Mesh GetDrawPassMesh(int pass)
        {
            return NativeCalls.godot_icall_1_608(method_bind_31, Object.GetPtr(this), pass);
        }

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private static IntPtr method_bind_32 = Object.godot_icall_Object_ClassDB_get_method(nativeName, "restart");
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private static IntPtr method_bind_33 = Object.godot_icall_Object_ClassDB_get_method(nativeName, "capture_aabb");

        /// <summary>
        /// <para>Returns the axis-aligned bounding box that contains all the particles that are active in the current frame.</para>
        /// </summary>
        [GodotMethod("capture_aabb")]
        public AABB CaptureAabb()
        {
            NativeCalls.godot_icall_0_158(method_bind_33, Object.GetPtr(this), out AABB argRet); return (AABB)argRet;
        }
    }
}

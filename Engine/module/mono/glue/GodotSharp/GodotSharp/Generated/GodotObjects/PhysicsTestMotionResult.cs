...
namespace Godot
{
    public partial class PhysicsTestMotionResult : Reference
    {
...
#pragma warning restore CS0618
        ...
        public Vector3 MotionRemainder
        {
            get
#pragma warning disable CS0618 // Disable warning about obsolete method
            {
...
#pragma warning restore CS0618
        ...
        private const string nativeName = "PhysicsTestMotionResult";

        public PhysicsTestMotionResult() : this(true)
        {
            if (ptr == IntPtr.Zero)
                ptr = NativeCalls.godot_icall_PhysicsTestMotionResult_Ctor(this);
        }

        internal PhysicsTestMotionResult(bool memoryOwn) : base(memoryOwn) {}
        ...
        public Vector3 GetMotionRemainder()
        {

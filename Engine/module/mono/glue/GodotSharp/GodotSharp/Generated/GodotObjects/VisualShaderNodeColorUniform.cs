...
namespace Godot
{
    ...
    {
        /// <summary>
        /// <para>Enables usage of the <see cref="Godot.VisualShaderNodeColorUniform.DefaultValue"/>.</para>
        /// </summary>
...
#pragma warning restore CS0618
        ...
        {
            NativeCalls.godot_icall_1_199(method_bind_2, Object.GetPtr(this), ref value);
        }

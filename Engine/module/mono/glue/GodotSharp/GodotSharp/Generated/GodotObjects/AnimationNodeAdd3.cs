...
{
    /// <summary>
    /// <para>A resource to add to an <see cref="Godot.AnimationNodeBlendTree"/>. Blends two animations together additively out of three based on a value in the <c>[-1.0, 1.0]</c> range.</para>
    ...
    /// </summary>
    public partial class AnimationNodeAdd3 : AnimationNode
    {
        /// <summary>
...
#pragma warning restore CS0618
        ...
        private const string nativeName = "AnimationNodeAdd3";

        public AnimationNodeAdd3() : this(true)
        {
            if (ptr == IntPtr.Zero)
                ptr = NativeCalls.godot_icall_AnimationNodeAdd3_Ctor(this);
        }

        internal AnimationNodeAdd3(bool memoryOwn) : base(memoryOwn) {}

...
{
    /// <summary>
    /// <para>3D obstacle used in navigation for collision avoidance. The obstacle needs navigation data to work correctly. This can be done by having the obstacle as a child of a <see cref="Godot.Navigation"/> node, or using <see cref="Godot.NavigationObstacle.SetNavigation"/>. <see cref="Godot.NavigationObstacle"/> is physics safe.</para>
    ...
    /// </summary>
    public partial class NavigationObstacle : Node
    {
        /// <summary>
...
#pragma warning restore CS0618
        ...
        /// <summary>
        /// <para>The radius of the agent. Used only if <see cref="Godot.NavigationObstacle.EstimateRadius"/> is set to <c>false</c>.</para>
        /// </summary>
        public float Radius
        {
            get
...
#pragma warning restore CS0618
        ...
        private const string nativeName = "NavigationObstacle";

        public NavigationObstacle() : this(false)
        {
            if (ptr == IntPtr.Zero)
                ptr = NativeCalls.godot_icall_NavigationObstacle_Ctor(this);
        }

        internal NavigationObstacle(bool memoryOwn) : base(memoryOwn) {}

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private static IntPtr method_bind_0 = Object.godot_icall_Object_ClassDB_get_method(nativeName, "get_rid");

        /// <summary>
        /// <para>Returns the <see cref="Godot.RID"/> of this obstacle on the <see cref="Godot.NavigationServer"/>.</para>
        /// </summary>
        [GodotMethod("get_rid")]
        public RID GetRid()
        {
        ...
        /// <summary>
        /// <para>Sets the <see cref="Godot.Navigation"/> node used by the obstacle. Useful when you don't want to make the obstacle a child of a <see cref="Godot.Navigation"/> node.</para>
        /// </summary>
        ...
        /// <summary>
        /// <para>Returns the <see cref="Godot.Navigation"/> node that the obstacle is using for its navigation system.</para>
        /// </summary>
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private static IntPtr method_bind_3 = Object.godot_icall_Object_ClassDB_get_method(nativeName, "is_radius_estimated");
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private static IntPtr method_bind_4 = Object.godot_icall_Object_ClassDB_get_method(nativeName, "set_estimate_radius");
        ...
        {
            NativeCalls.godot_icall_1_16(method_bind_4, Object.GetPtr(this), estimateRadius);
        }

...
{
    /// <summary>
    /// <para>A resource to add to an <see cref="Godot.AnimationNodeBlendTree"/>. Blends two animations linearly based on an amount value in the <c>[0.0, 1.0]</c> range.</para>
    /// </summary>
    public partial class AnimationNodeBlend2 : AnimationNode
    {
        /// <summary>
...
#pragma warning restore CS0618
        ...
        private const string nativeName = "AnimationNodeBlend2";

        public AnimationNodeBlend2() : this(true)
        {
            if (ptr == IntPtr.Zero)
                ptr = NativeCalls.godot_icall_AnimationNodeBlend2_Ctor(this);
        }

        internal AnimationNodeBlend2(bool memoryOwn) : base(memoryOwn) {}

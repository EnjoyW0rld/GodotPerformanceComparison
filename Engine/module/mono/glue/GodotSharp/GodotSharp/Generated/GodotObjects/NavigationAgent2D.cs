...
{
    /// <summary>
    /// <para>2D agent that is used in navigation to reach a location while avoiding static and dynamic obstacles. The dynamic obstacles are avoided using RVO (Reciprocal Velocity Obstacles) collision avoidance. The agent needs navigation data to work correctly. By default this node will register to the default <see cref="Godot.World2D"/> navigation map. If this node is a child of a <see cref="Godot.Navigation2D"/> node it will register to the navigation map of the navigation node or the function <see cref="Godot.NavigationAgent2D.SetNavigation"/> can be used to set the navigation node directly. <see cref="Godot.NavigationAgent2D"/> is physics safe.</para>
    /// <para>Note: After <see cref="Godot.NavigationAgent2D.SetTargetLocation"/> is used it is required to use the <see cref="Godot.NavigationAgent2D.GetNextLocation"/> function once every physics frame to update the internal path logic of the NavigationAgent. The returned vector position from this function should be used as the next movement position for the agent's parent Node.</para>
...
#pragma warning restore CS0618
        ...
        /// <summary>
        /// <para>A bitfield determining all navigation map layers the <see cref="Godot.NavigationAgent2D"/> belongs to. On path requests the agent will ignore navmeshes without at least one matching layer.</para>
        /// </summary>
...
#pragma warning restore CS0618
        ...
        /// <summary>
        /// <para>The radius of the avoidance agent. This is the "body" of the avoidance agent and not the avoidance maneuver starting radius (which is controlled by <see cref="Godot.NavigationAgent2D.NeighborDist"/>).</para>
...
#pragma warning restore CS0618
        ...
        private const string nativeName = "NavigationAgent2D";

        public NavigationAgent2D() : this(false)
        {
            if (ptr == IntPtr.Zero)
                ptr = NativeCalls.godot_icall_NavigationAgent2D_Ctor(this);
        }
        ...
        /// <summary>
        /// <para>Returns the <see cref="Godot.RID"/> of this agent on the <see cref="Godot.Navigation2DServer"/>.</para>
        /// </summary>
        [GodotMethod("get_rid")]
        public RID GetRid()
        {
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private static IntPtr method_bind_9 = Object.godot_icall_Object_ClassDB_get_method(nativeName, "set_navigation");

        /// <summary>
        /// <para>Sets the <see cref="Godot.Navigation2D"/> node used by the agent. Useful when you don't want to make the agent a child of a <see cref="Godot.Navigation2D"/> node.</para>
        /// </summary>
        [GodotMethod("set_navigation")]
        public void SetNavigation(Node navigation)
        {
            NativeCalls.godot_icall_1_53(method_bind_9, Object.GetPtr(this), Object.GetPtr(navigation));
        }

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private static IntPtr method_bind_10 = Object.godot_icall_Object_ClassDB_get_method(nativeName, "get_navigation");

        /// <summary>
        /// <para>Returns the <see cref="Godot.Navigation2D"/> node that the agent is using for its navigation system.</para>
        /// </summary>
        [GodotMethod("get_navigation")]
        public Node GetNavigation()
        {
            return NativeCalls.godot_icall_0_257(method_bind_10, Object.GetPtr(this));
        }

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private static IntPtr method_bind_11 = Object.godot_icall_Object_ClassDB_get_method(nativeName, "set_neighbor_dist");
        ...
        {
            NativeCalls.godot_icall_1_15(method_bind_11, Object.GetPtr(this), neighborDist);
        }

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private static IntPtr method_bind_12 = Object.godot_icall_Object_ClassDB_get_method(nativeName, "get_neighbor_dist");
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private static IntPtr method_bind_13 = Object.godot_icall_Object_ClassDB_get_method(nativeName, "set_max_neighbors");
        ...
        {
            NativeCalls.godot_icall_1_4(method_bind_13, Object.GetPtr(this), maxNeighbors);
        }

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private static IntPtr method_bind_14 = Object.godot_icall_Object_ClassDB_get_method(nativeName, "get_max_neighbors");
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private static IntPtr method_bind_15 = Object.godot_icall_Object_ClassDB_get_method(nativeName, "set_time_horizon");
        ...
        {
            NativeCalls.godot_icall_1_15(method_bind_15, Object.GetPtr(this), timeHorizon);
        }

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private static IntPtr method_bind_16 = Object.godot_icall_Object_ClassDB_get_method(nativeName, "get_time_horizon");
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private static IntPtr method_bind_17 = Object.godot_icall_Object_ClassDB_get_method(nativeName, "set_max_speed");

        [GodotMethod("set_max_speed")]
        [Obsolete("SetMaxSpeed is deprecated. Use the MaxSpeed property instead.")]
        public void SetMaxSpeed(float maxSpeed)
        {
            NativeCalls.godot_icall_1_15(method_bind_17, Object.GetPtr(this), maxSpeed);
        }

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private static IntPtr method_bind_18 = Object.godot_icall_Object_ClassDB_get_method(nativeName, "get_max_speed");
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private static IntPtr method_bind_19 = Object.godot_icall_Object_ClassDB_get_method(nativeName, "set_path_max_distance");
        ...
        {
            NativeCalls.godot_icall_1_15(method_bind_19, Object.GetPtr(this), maxSpeed);
        }

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private static IntPtr method_bind_20 = Object.godot_icall_Object_ClassDB_get_method(nativeName, "get_path_max_distance");
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private static IntPtr method_bind_21 = Object.godot_icall_Object_ClassDB_get_method(nativeName, "set_navigation_layers");
        ...
        {
            NativeCalls.godot_icall_1_187(method_bind_21, Object.GetPtr(this), navigationLayers);
        }

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private static IntPtr method_bind_22 = Object.godot_icall_Object_ClassDB_get_method(nativeName, "get_navigation_layers");
        ...
        {
            return NativeCalls.godot_icall_0_188(method_bind_22, Object.GetPtr(this));
        }

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private static IntPtr method_bind_23 = Object.godot_icall_Object_ClassDB_get_method(nativeName, "set_navigation_map");
        ...
        {
            NativeCalls.godot_icall_1_285(method_bind_23, Object.GetPtr(this), RID.GetPtr(navigationMap));
        }

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private static IntPtr method_bind_24 = Object.godot_icall_Object_ClassDB_get_method(nativeName, "get_navigation_map");

        /// <summary>
        /// <para>Returns the <see cref="Godot.RID"/> of the navigation map for this NavigationAgent node. This function returns always the map set on the NavigationAgent node and not the map of the abstract agent on the NavigationServer. If the agent map is changed directly with the NavigationServer API the NavigationAgent node will not be aware of the map change. Use <see cref="Godot.NavigationAgent2D.SetNavigationMap"/> to change the navigation map for the NavigationAgent and also update the agent on the NavigationServer.</para>
        /// </summary>
        [GodotMethod("get_navigation_map")]
        public RID GetNavigationMap()
        {
            return new RID(NativeCalls.godot_icall_0_254(method_bind_24, Object.GetPtr(this)));
        }

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private static IntPtr method_bind_25 = Object.godot_icall_Object_ClassDB_get_method(nativeName, "set_target_location");
        ...
        {
            NativeCalls.godot_icall_1_57(method_bind_25, Object.GetPtr(this), ref location);
        }

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private static IntPtr method_bind_26 = Object.godot_icall_Object_ClassDB_get_method(nativeName, "get_target_location");

        /// <summary>
        /// <para>Returns the user-defined target location (set with <see cref="Godot.NavigationAgent2D.SetTargetLocation"/>).</para>
        /// </summary>
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private static IntPtr method_bind_27 = Object.godot_icall_Object_ClassDB_get_method(nativeName, "get_next_location");
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private static IntPtr method_bind_28 = Object.godot_icall_Object_ClassDB_get_method(nativeName, "distance_to_target");

        /// <summary>
        /// <para>Returns the distance to the target location, using the agent's global position. The user must set the target location with <see cref="Godot.NavigationAgent2D.SetTargetLocation"/> in order for this to be accurate.</para>
        /// </summary>
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private static IntPtr method_bind_29 = Object.godot_icall_Object_ClassDB_get_method(nativeName, "set_velocity");
        ...
        {
            NativeCalls.godot_icall_1_57(method_bind_29, Object.GetPtr(this), ref velocity);
        }

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private static IntPtr method_bind_30 = Object.godot_icall_Object_ClassDB_get_method(nativeName, "get_nav_path");

        /// <summary>
        /// <para>Returns this agent's current path from start to finish in global coordinates. The path only updates when the target location is changed or the agent requires a repath. The path array is not intended to be used in direct path movement as the agent has its own internal path logic that would get corrupted by changing the path array manually. Use the intended <see cref="Godot.NavigationAgent2D.GetNextLocation"/> once every physics frame to receive the next path point for the agents movement as this function also updates the internal path logic.</para>
        /// </summary>
        [GodotMethod("get_nav_path")]
        public Vector2[] GetNavPath()
        {
            return NativeCalls.godot_icall_0_236(method_bind_30, Object.GetPtr(this));
        }

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private static IntPtr method_bind_31 = Object.godot_icall_Object_ClassDB_get_method(nativeName, "get_nav_path_index");
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private static IntPtr method_bind_32 = Object.godot_icall_Object_ClassDB_get_method(nativeName, "is_target_reached");

        /// <summary>
        /// <para>Returns <c>true</c> if the target location is reached. The target location is set using <see cref="Godot.NavigationAgent2D.SetTargetLocation"/>. It may not always be possible to reach the target location. It should always be possible to reach the final location though. See <see cref="Godot.NavigationAgent2D.GetFinalLocation"/>.</para>
        /// </summary>
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private static IntPtr method_bind_33 = Object.godot_icall_Object_ClassDB_get_method(nativeName, "is_target_reachable");

        /// <summary>
        /// <para>Returns <c>true</c> if the target location is reachable. The target location is set using <see cref="Godot.NavigationAgent2D.SetTargetLocation"/>.</para>
        /// </summary>
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private static IntPtr method_bind_34 = Object.godot_icall_Object_ClassDB_get_method(nativeName, "is_navigation_finished");
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private static IntPtr method_bind_35 = Object.godot_icall_Object_ClassDB_get_method(nativeName, "get_final_location");
        ...
        public Vector2 GetFinalLocation()
        {

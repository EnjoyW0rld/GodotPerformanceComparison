...
{
    /// <summary>
    /// <para>Contains collision data for <see cref="Godot.KinematicBody2D"/> collisions. When a <see cref="Godot.KinematicBody2D"/> is moved using <see cref="Godot.KinematicBody2D.MoveAndCollide"/>, it stops if it detects a collision with another body. If a collision is detected, a KinematicCollision2D object is returned.</para>
    ...
    /// </summary>
    public partial class KinematicCollision2D : Reference
    {
        /// <summary>
...
#pragma warning restore CS0618
        ...
        /// <summary>
        /// <para>The colliding body's <see cref="Godot.RID"/> used by the <see cref="Godot.Physics2DServer"/>.</para>
        /// </summary>
...
#pragma warning restore CS0618
        ...
        /// <summary>
        /// <para>The colliding shape's index. See <see cref="Godot.CollisionObject2D"/>.</para>
        /// </summary>
...
#pragma warning restore CS0618
        ...
        private const string nativeName = "KinematicCollision2D";

        public KinematicCollision2D() : this(true)
        {
            if (ptr == IntPtr.Zero)
                ptr = NativeCalls.godot_icall_KinematicCollision2D_Ctor(this);
        }
        ...
        public float GetAngle(Nullable<Vector2> upDirection = null)
        {
            Vector2 upDirection_in = upDirection.HasValue ? upDirection.Value : new Vector2(0, -1);
            return NativeCalls.godot_icall_1_350(method_bind_4, Object.GetPtr(this), ref upDirection_in);
        }
